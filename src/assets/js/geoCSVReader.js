...
//     let layerLevel = 1
//     const category_id = populateTree(
//       tree,
//       data[1],
//       folderSequence,
//       data[2] !== ''
...
//       const major_class_id = populateTree(
//         tree[category_id].subFolder,
//         data[2],
//         folderSequence,
//         data[3] !== ''
//       )
...
//         const sub_class_id = populateTree(
//           tree[category_id].subFolder[major_class_id].subFolder,
//           data[3],
//           folderSequence,
//           data[4] !== ''
//         )
...
//           populateTree(
//             tree[category_id].subFolder[major_class_id].subFolder[sub_class_id]
//               .subFolder,
//             data[4],
//             folderSequence,
//             false
